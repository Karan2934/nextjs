        ...
        <div className='p-7'>
                            ...
                            <div className="lg:flex">
                                ...
                                <div>
                                    <div className="flex relative">
                                        <img src="/icons/shape-24.png" className="hidden 2xl:block absolute lg:left-30" />
                                        <img
                                            src={data.image}
            ...
            <div className='pt-3'>
                <div className='bg-[#1B152C] rounded-3xl min-h-27 lg:flex-row flex flex-col justify-center items-center p-9'>
                    <div className='mr-8 pr-14 w-48 px-9'>
                        <div className="text-gray-100 lg:min-w-[175px] min-w-[250px] lg:border-r border-white font-bold gap-1 flex">
                            <p className="">{sliderData.companySlider.title}</p>
