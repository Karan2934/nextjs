    ...
    <div className='p-7'>
      <div className='bg-[url(/icons/pattern-7.png)] bg-[#1b152c] bg-cover bg-center bg-no-repeat min-h-100 rounded-3xl'>
          ...
          <div className='rounded-4xl bg-[url(/icons/footer-bg.jpg)] w-full max-w-4/5 bg-cover bg-center'>
            <div className='w-full bg-gradient-to-r from-[#a051e6a8] to-[#6b43e3] bg-center bg-no-repeat min-h-36 flex items-center justify-center rounded-3xl'>
              <div className='flex flex-col md:flex-row items-center gap-4 md-gap-10'>
                ...
                <div className='flex items-center justify-center space-x-2 lg:space-x-3'>
                  <div className='bg-white p-3 rounded-full'>
                    <FontAwesomeIcon icon={faEnvelope} className='text-[#6c43e3] h-5 w-5' />
                  </div>
                  <div>
                ...
                <div className='flex items-center justify-center space-x-2 lg:space-x-3'>
                  <div className='bg-white p-3 rounded-full'>
                    <FontAwesomeIcon icon={faPhone} className='text-[#6c43e3] h-5 w-5' />
                  </div>
                  <div>
        ...
        <div className='p-7 flex flex-col xl:ml-36 xl:mr-36 sm:grid sm:grid-cols-1 md:grid md:grid-cols-2 lg:flex lg:flex-row items-start gap-4'>
          <div className='w-full lg:flex-1 h-64'>
            ...
            <div className='flex gap-5'>
              <FontAwesomeIcon icon={faFacebookF} className='h-11 w-11 text-white bg-[#0d0a16] p-3 rounded-full hover:bg-[#6c43e3] delay-300 transition-all' />
              <FontAwesomeIcon icon={faTwitter} className='h-11 w-11 text-white bg-[#0d0a16] p-3 rounded-full' />
              <FontAwesomeIcon icon={faPinterestP} className='h-11 w-11 text-white bg-[#0d0a16] p-3 rounded-full' />
              <FontAwesomeIcon icon={faYoutube} className='h-11 w-11 text-white bg-[#0d0a16] p-3 rounded-full' />
            </div>
          </div>
        ...
        <div className='bg-gradient-to-r from-[#a051e6f1] to-[#6b43e3] rounded-b-3xl'>
          <div className='flex ml-36 mr-36 items-center justify-between'>
            <p className='text-white'>© Copyright 2025 by Company.com</p>
            <div className='flex flex-col lg:flex-row gap-5 items-center'>
              <p className='text-white'>Terms & Conditions</p>
              <p className='text-white'>Privacy Policy</p>
              <button className='bg-[#ED8A33] text-white p-5 pr-12 flex items-center gap-2 mr-8 hover:bg-[#6b43e3]'>
