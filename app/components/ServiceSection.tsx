    ...
    <div className='px-7 -mt-7'>
      ...
      <div className='relative flex flex-col justify-center items-center '>
        ...
        <div className='absolute flex flex-col justify-center items-center'>
          ...
          <p className='font-bold text-4xl opacity-20'>Services We're Offering to Customers</p>
        </div>
      ...
      <div className='lg:flex sm:grid sm:grid-cols-1 md:grid md:grid-cols-2 sm:justify-items-center lg:justify-between'>
        {JsonData.services.map((service, index) => (
          <div key={index} className='p-2 w-96 group'>
            <div className={`bg-white transition-all duration-300 group-hover:bg-[#a051e6]  relative pt-10 pb-3.5 pl-12 pr-7 shadow-xl rounded-tl-[150px] min-h-36 rounded-t-xl flex flex-col justify-between items-end ${service.margin === 15 ? 'lg:-mt-15' : 'lg:-mt-35'}`}>
              <div className='p-4'>
                <img src={service.logo} className='group-hover:hidden absolute rounded-full left-0 h-24 w-24 top-5 p-5 bg-gradient-to-r from-[#a051e6] to-[#6b43e3]' />
                <img src={service.hover} className='hidden group-hover:block absolute rounded-full left-0 h-24 w-24 top-5 p-5 bg-black' />
              </div>
            ...
            <div className='bg-white transition-all duration-300 group-hover:bg-[#a051e6] rounded-b-4xl overflow-hidden shadow-xl relative'>
      ...
      <div className='pt-28 lg:flex-row items-center lg:gap-2 gap-30 justify-center flex flex-col'>
        ...
        <div className='pl-5 relative lg:w-xl w-full order-1 lg:order-2'>
          ...
          <p className='relative m-2  text-[#736c87] font-semibold uppercase '>
            ...
            About us</p>
          <p className='  font-bold text-4xl m-2 mb-7'>{JsonData.about.title}</p>
